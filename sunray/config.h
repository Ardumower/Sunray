...
/* 
   ...
   + Ardumower PCB 1.3 
   +   1 Adafruit Grand Central M4 (highly recommendeZwei Fragen.d) or Arduino Due 
...
#define WIFI_IP   192,168,68,150    // choose IP e.g. 192,168,4,1  (comment out for dynamic IP/DHCP) - NOTE: use commans instead of points
#define WIFI_SSID "roontoon"        // choose WiFi network ID
#define WIFI_PASS "23594lgx"        // choose WiFi network password
...
#define UDP_SERVER_IP   192,168,68,150     // remote UDP IP and port to connect to
#define UDP_SERVER_PORT 4210

// --------- NTRIP client (linux only, highly experimental) ---------------------------------
#define NTRIP_HOST "40.121.75.206"   // sapos nrw
#define NTRIP_PORT 10000
#define NTRIP_MOUNT "MSM4_NEAR"
#define NTRIP_USER "roontoon"
#define NTRIP_PASS "23594lgx"
...
#define ALLOW_ROUTE_OUTSIDE_PERI_METER 1.0   // max. distance (m) to allow routing from outside perimeter                                               // (increase if you get 'no map route' errors near perimeter)
