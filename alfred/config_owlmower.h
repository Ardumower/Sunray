...
#define LIDAR_BUMPER_TILT_ANGLE        25.0  	// LiDAR tilt angle (deg)
...
#define LIDAR_BUMPER_MAX_HEIGHT         1.0   // search area max height
...
#define GO_HOME_VOLTAGE   20.5  // start going to dock below this voltage
