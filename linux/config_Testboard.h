...
#define WS_PORT 443
#define WS_ROBOT_CONNECT_KEY "0de2fa47b77f23d6b75a8adf6dab9b84"
#define WS_USE_TLS 1
...
#define TICKS_PER_REVOLUTION  1100     // odometry ticks per wheel revolution (RM24)
...
// When activated, Sunray will ignore power-off commands for the specified duration and then allow normal shutdowns again.

#define SIMULATE_SUNRAY_POWER_OFF_HANG true // true to activate simulation of power-off hang, false to disable

#define SIMULATE_SUNRAY_POWER_OFF_HANG_DURATION_SEC 30 // duration in seconds to simulate power-off hang
